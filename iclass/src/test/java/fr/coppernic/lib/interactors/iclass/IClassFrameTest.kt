...
class IClassFrameTest {
    ...
    private val frameHfTest32bit3 = IClassFrame(byteArrayOf(0x00, 0x11, 0x0A, 0x44, 0x00,
            0x00, 0x00, 0x00, 0xBD.toByte(), 0x09, 0x9E.toByte(), 0x07, 0x81.toByte(), 0x05, 0x00,
    ...
    fun getPacs() {
        ...
        frameHfTest32bit3.pacs.toTypedArray() `should equal` byteArrayOf(0x3A, 0xA5.toByte(), 0x18,
                0x04).toTypedArray()
        frameHfTest32bit3.pacsBinaryString `should equal` "00111010101001010001100000000100"
        frameHfTest32bit3.type `should equal` Type.HF
        frameHfTest32bit3.cardNumber `should equal` 35842
        frameHfTest32bit3.facilityCode `should equal` 82
        frameHfTest32bit3.bitLength `should equal` 32
